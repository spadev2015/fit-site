...
* @see https://v0.dev/t/z79rXqWhECp
...
export function fitLanding() {
  return (
    <>
      <section className="w-full py-20 md:py-32 lg:py-40 overflow-hidden bg-custom-image">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 md:grid-cols-2 items-center">
            <div className="space-y-6 md:space-y-8">
              <h1 className="text-5xl md:text-5xl lg:text-7xl font-bold tracking-tighter text-white animate-trace text-shadow">
                Transform Your Body, Transform Your Life
              </h1>
              <p className="text-lg md:text-3xl text-white animate-trace text-shadow">
      ...
      <section className="w-full py-12 md:py-20 lg:py-24 bg-white overflow-hidden">
        <div className="container px-4 md:px-6">
          <h1 className="text-5xl font-bold text-gray-900 pt-4 pb-12 md:pb-12 lg:pb-12 text-center">
            1-on-1 Coaching
          </h1>

          <div className="grid gap-6 md:grid-cols-1 lg:grid-cols-3">
            <div className="bg-gray-100 rounded-lg p-8 shadow-sm transition-all hover:scale-105 hover:shadow-md">
              <h2 className="text-2xl space-y-2 text-gray-700 mb-4 font-bold tracking-wider">
                Personalized Meal Plan
              </h2>
              <p className="space-y-2 text-gray-700 mb-4">
                Customized Meal Plan Just for you. Get a meal plan designed
                specifically for your goals, schedule, and lifestyle. Your plan
                will be updated every month based on your progress.
              </p>
              <ul className="space-y-2 text-gray-700 list-outside">
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Customized meal plans based on your fitness goals
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                ...
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Recipes and cooking tips for balanced meals
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Ongoing support and adjustments to your meal plan
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
            ...
            <div className="bg-gray-100 rounded-lg p-8 shadow-sm transition-all hover:scale-105 hover:shadow-md">
              ...
              <p className="space-y-2 text-gray-700 mb-4">
                Get a custom workout plan just for you! Detailed videos show you
                how to do each exercise properly.
              </p>
              <ul className="space-y-2 text-gray-700 list-outside">
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Structured strength and muscle-building workout plans
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                ...
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Detailed exercise instructions and tips for proper form
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Personalized workout recommendations to match your goals
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Regular updates and program adjustments based on your progress
                </li>
              </ul>
              <div className="mt-6">
                <Link
            ...
            <div className="bg-gray-100 rounded-lg p-8 shadow-sm transition-all hover:scale-105 hover:shadow-md">
              <h3 className="text-2xl font-bold text-gray-900 mb-4">
                Ultimate Fitness & Nutrition Plan
              </h3>
              <p className="space-y-2 text-gray-700 mb-4">
                Transform integrates the personalized nutrition plans from Fule
                and the strength-building workout routines from Build to help
                you achieve a total body transformation.
              </p>
              <ul className="space-y-2 text-gray-700 list-outside">
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  One-on-one coaching & feedback sessions for personalized
                  support
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                ...
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  An Integrated approach to balance diet and exercise for
                  optimal results
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Access to a community of like-minded individuals for support
                  and motivation
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Holistic wellness tips including sleep, stress management, and
                  recovery
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Goal setting and achievement tracking to keep you motivated
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Personalized progress reports to visualize your transformation
                  journey
                </li>
                <li className="text-base sm:text-sm md:text-sm">
                  <CheckIcon className="h-5 w-5 text-indigo-500 inline-block mr-2" />
                  Access to exclusive resources and expert insights on fitness
                  and nutrition
                </li>
              </ul>
              <div className="mt-6">
      ...
      <section className="w-full py-20 md:py-32 lg:py-40 bg-gray-100 overflow-hidden">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 md:grid-cols-1 items-center">
          <div className="grid grid-cols-1 md:grid-cols-1 gap-4 px-20">
            <div className="flex justify-center">
                <Image 
                  ...
                  width={400}
                  height={400}
                  className="w-full md:w-3/4 lg:w-1/2 h-auto border-white border-4"
                />
              </div>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 grid grid-cols-1 md:grid-cols-1 gap-4 px-20">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter text-gray-900 animate-trace">
                My Journey to Elite Strength Coaching
              </h2>
              <p className="text-lg md:text-xl text-gray-700 animate-trace">
                I didn&apos;t always understand the importance of fitness and
                proper nutrition. In my early years, I didn&apos;t pay much
                attention to how my lifestyle choices affected my health. When I
                moved to America in my mid-twenties, I lived the party
                lifestyle, not thinking about how important it was to stay
                healthy.
              </p>
              <p className="text-lg md:text-xl text-gray-700 animate-trace">
                As time went on, I realized how important fitness and nutrition
                are for both mental and physical well-being. This sparked my
                interest in health and fitness, and I started getting into
                bodybuilding. I tried every diet out there and found that the
                only thing that works is a clean diet and regular workouts. I
                changed my workout routines and eating habits, transforming my
                body and developing a passion for fitness.
              </p>
              <p className="text-lg md:text-xl text-gray-700 animate-trace">
                I wanted to share my journey and help others, so I became a
                certified fitness and nutrition coach. With this knowledge and
      ...
      <section className="w-full py-20 md:py-20 lg:py-40 bg-gray-900 text-white overflow-hidden">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 md:grid-cols-2 items-center">
            <div className="space-y-4 md:space-y-6">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tighter animate-trace">
                Elite Strength Coaching
              </h2>
            </div>
            <div>
              <p className="text-lg md:text-xl animate-trace">
                Elite Strength Coaching offers personalized fitness and
                nutrition programs designed to help you achieve your health and
                wellness goals through tailored workouts and clean eating
                habits.
              </p>
              {/* <Link
                className="inline-flex items-center mt-4 mb-4 justify-center h-10 px-6 rounded-md bg-indigo-500 text-white font-medium transition-colors hover:bg-indigo-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2"
                href="#"
              >
                Get Started
              </Link> */}
          ...
          <div className="w-full flex justify-center">
              <Image
                ...
                height={984}
                layout="intrinsic"
                className="sm:w-1/3 md:w-1/2 lg:w-1/2 w-full pt-20 pb-20"
              />
          </div>
        </div>
        <div className="flex justify-center py-10">
            <h4 className="text-3xl md:text-3xl lg:text-4xl font-bold tracking-tighter animate-tracer">Client Results</h4>
          </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-20">
          <div className="flex justify-center">
            <Image
              src="/color-transform1.png"
              alt="Image 1"
              width={300}
              height={300}
              className="w-full h-auto  border-white border-4"
          ...
          <div className="flex justify-center">
            <Image
              src="/color-transform3.png"
              alt="Image 3"
              width={300}
              height={300}
              className="w-3/4 h-auto border-white border-4"
            />
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="bento py-20 container">
          <div className="mx-auto px-6 text-gray-500">
            <div className="relative">
              <div className="relative z-10 grid gap-3 grid-cols-6">
                <div className="col-span-full lg:col-span-2 overflow-hidden flex justify-center items-center p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div className="relative flex flex-col items-center size-fit">
                    <div className="relative h-24 w-56 flex items-center justify-center">
                      ...
                      <span className="text-center w-fit block mx-auto text-5xl font-semibold text-transparent bg-clip-text bg-gradient-to-br from-blue-300 to-pink-600 dark:from-blue-400 dark:to-pink-400">
                        100%
                      </span>
                    </div>
                    <h2 className="mt-6 text-center font-semibold text-gray-950 dark:text-white text-3xl">
                      Customized workout plans designed just for you
                    </h2>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="mt-6 text-center relative z-10 space-y-2">
                      ...
                      <p className="dark:text-gray-300 text-gray-700">
                        Transform your health and wellness with a customized
                        nutrition plan tailored specifically to your unique
                        needs and goals.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-span-full sm:col-span-3 lg:col-span-2 overflow-hidden relative p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div>
                    ...
                    <div className="mt-14 text-center relative z-10 space-y-2">
                      <h2 className="text-lg font-medium text-gray-800 transition group-hover:text-purple-950 dark:text-white">
                        Goal Setting and Tracking in Our Mobile App
                      </h2>
                      <p className="dark:text-gray-300 text-gray-700">
                        Achieve your fitness goals with precision and ease using
                        our mobile app, designed to help you set, track, and
                        conquer your milestones effectively.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid sm:grid-cols-2">
                    <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                      ...
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium text-gray-800 transition group-hover:text-purple-950 dark:text-white">
                          Workout Tracking in Our Mobile App
                        </h2>
                        <p className="dark:text-gray-300 text-gray-700">
                          Elevate your fitness journey with our mobile app,
                          featuring seamless workout tracking to monitor your
                          progress, stay motivated, and achieve your goals
                          efficiently.
                        </p>
                      </div>
                    </div>
                ...
                <div className="col-span-full lg:col-span-3 overflow-hidden relative p-8 rounded-xl bg-white border border-gray-200 dark:border-gray-800 dark:bg-gray-900">
                  <div className="h-full grid sm:grid-cols-2">
                    <div className="flex flex-col justify-between relative z-10 space-y-12 lg:space-y-6">
                      ...
                      <div className="space-y-2">
                        <h2 className="text-lg font-medium text-gray-800 transition group-hover:text-purple-950 dark:text-white">
                          Nutrition Tracking in Our Mobile App
                        </h2>
                        <p className="dark:text-gray-300 text-gray-700">
                          Monitor and enhance your dietary habits with our
                          mobile app, designed to help you stay on top of your
                          nutritional intake and achieve your health goals with
                          ease.
                        </p>
                      </div>
                    </div>
